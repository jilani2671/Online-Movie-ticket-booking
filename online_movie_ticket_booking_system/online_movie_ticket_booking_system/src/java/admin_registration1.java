 ...
 * @author Jilani
 */
public class admin_registration1 extends HttpServlet {
Connection cn=null;
Statement st=null;
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(event.equals("Create Account"))
        {
            if(first_name.equals("")|| last_name.equals("")|| phone_no.equals("")||email_id.equals("")||password.equals("")||con_pass.equals(""))
             ...
             try
             {
              String sql= "insert into admin_registration(first_name,last_name,phone_no,email_id,password,con_pass)values('"+first_name+"','"+last_name+"','"+phone_no+"','"+email_id+"','"+password+"','"+con_pass+"')";
